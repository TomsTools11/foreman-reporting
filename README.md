# Foreman Agency — Client Reporting

A simple static landing page that delivers campaign and account-review reports
to Foreman Agency, prepared by **GOAL Performance Marketing**.
...
│   ├── 1 - Refined Light.html
│   ├── 2 - Navy Editorial.html
│   └── 3 - Structured Dashboard.html
...
The `report-templates/` folder holds blank starting points (three visual
styles) you can copy from when building a new report.
...
(e.g. `/reports/2026-06-01-geographic-targeting-footprint`).
